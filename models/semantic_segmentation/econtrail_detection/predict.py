...
from .utils import Full_scene_probab_mask1
...
def run_inference(
    ...
    """
    return Full_scene_probab_mask1(
        model,
        str(image_path),
        device,
        tile_h,
...
""" example:
  ...
  --image /home/irortiza/Documents/PUBLIC_GITHUB/ECONTRAIL_detection/data/ash_rgb_0p02deg.png \
  --tile-h 256 \
  --tile-w 256 \
  --stride 128 \
  --threshold 0.1 \
