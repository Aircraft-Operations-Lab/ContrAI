...
""" example:
    python -m models.semantic_segmentation.econtrail_detection.predict_old \
  --model-path ~/Documents/PUBLIC_GITHUB/ECONTRAIL_detection/models/semantic_segmentation/econtrail_detection/weights/contrail/model.pth \
  --image /home/irortiza/Documents/PUBLIC_GITHUB/ECONTRAIL_detection/data/GOES16/goes16_ash_rgb/2025/01/05/1030/ash_rgb_0p02deg.png \
  --tile-h 256 \
  --tile-w 256 \
  --stride 128 \
  --threshold 0.1 \
